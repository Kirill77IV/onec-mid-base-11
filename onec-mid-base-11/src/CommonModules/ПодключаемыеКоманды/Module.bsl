...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//НачалоДоработки
	//Иванов К.В. Командная работа (EDT) Задача 1. Дата 20.09.2026г.
	//Добавить на форму документов поле "Контактное лицо"
	РК_РаботаСФормамиКлиентСервер.ДополнитьФрму(Форма);
	//КонецДоработки
